                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="tab">
                                    <button style="color: #33BFF2; font-size: smaller;" class="tablinks"
                                        onclick="openCity(event, 'London')"> <strong> For All
                                            Districts </strong></button>
                                    <button style="color: #33BFF2; font-size: smaller;" class="tablinks"
                                        onclick="openCity(event, 'Paris')">
                                        <strong> For Specific
                                            District </strong> </button>
                                    <button style="color: #33BFF2; font-size: smaller;" class="tablinks"
                                ...
                                <div id="Paris" class="tabcontent">
                                    <form action="generate_district_report.php" method="post">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="card card-default">
                                                    <div class="card-header">
                                                        <h5 class="card-title" style="text-align: center;"> District
                                                            Selection
                                                        </h5>
                                                    </div>
                                                    <div class="card-body">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group">
                                                                <select name="district" value="" class="form-control"
                                                                    required="true">
